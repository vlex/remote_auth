...
Download the "remote_auth.php":http://github.com/vlex/remote_auth/raw/master/SingleSingOnVlex.java file to your local server, then call the remote authentication function passing the appropriate parameters, for instance:
